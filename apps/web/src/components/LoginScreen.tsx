      ...
      <div className="relative flex min-h-screen items-center justify-center bg-slate-50 p-6 dark:bg-slate-950">
        ...
        <div className="w-full max-w-sm space-y-3 rounded-xl bg-white p-6 shadow-xl dark:bg-slate-900">
          ...
          {stores.map((store) => (
            <button
              key={store.id}
              className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-left text-slate-900 hover:border-indigo-400 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 p-6 dark:bg-slate-950">
      ...
      <form
        ...
        className="w-full max-w-sm space-y-4 rounded-xl bg-white p-6 shadow-xl dark:bg-slate-900"
      >
        <h1 className="text-lg font-semibold text-slate-900 dark:text-white">{t("web.appTitle")}</h1>
        <label className="block text-sm text-slate-600 dark:text-slate-300">
          {t("auth.email")}
          <input
            type="email"
